...
import { useDeleteSubRegion } from "@/hooks/sub-regions/useDeleteSubRegion";
...
export const RegionsActionsCell = ({ row, setRefreshData }: any) => {
    ...
    const { mutateAsync, isPending } = useDeleteSubRegion();
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem
                        onClick={() => navigate(`/sub-regions/${row.original.id}/edit`)}
                    >
                        {t("buttons.edit")}
                    </DropdownMenuItem>
            ...
            <DeleteDialog
                ...
                title={t("subregions.deleteTitle")}
